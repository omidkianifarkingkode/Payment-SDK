...
namespace GamePaymentSDK.Samples
{
    public sealed class PaymentBootstrapDirect : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            IPaymentWebViewService webViewService = ResolveWebViewService(_settings, logger);
            ...
            GamePayment.Setup(_settings, webViewService, logger);
        }
        ...
        private IPaymentWebViewService ResolveWebViewService(PaymentSettings settings, ILogger logger)
        {
#if UNITY_EDITOR
            if (_mockWebViewService != null)
            {
                _mockWebViewService.SetSettings(settings);
                _mockWebViewService.Logger = logger;
